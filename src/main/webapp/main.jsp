...
<body>
	...
	<nav class="navbar">
		<div class="container">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="meet.jsp" class="dropdown-toggle"
	...
	<div class="container">
		<div class="box" style="background-color: #fee;">공지사항</div>
		<div class="box" style="background-color: #efe;">사진</div>
		<div class="box" style="background-color: #eef;">유기견정보</div>
	</div>
